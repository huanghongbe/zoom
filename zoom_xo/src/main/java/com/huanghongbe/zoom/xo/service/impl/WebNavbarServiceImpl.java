...
import com.huanghongbe.zoom.xo.mapper.WebNavbarMapper;
...
//        page.setSize(webNavbarVO.getPageSize());
        ...
        IPage<WebNavbar> pageList = webNavbarService.page(
                new Page<>(webNavbarVO.getCurrentPage(),webNavbarVO.getPageSize()), queryWrapper);
        return pageList;
    }
    ...
    public String addWebNavbar(WebNavbarVO webNavbarVO) {
        ...
        webNavbarService.save(webNavbar);
