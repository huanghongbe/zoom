...
import com.huanghongbe.zoom.xo.mapper.SysDictTypeMapper;
...
//        page.setSize(sysDictTypeVO.getPageSize());
        ...
        IPage<SysDictType> pageList = sysDictTypeService.page(
                new Page<>(sysDictTypeVO.getCurrentPage(),sysDictTypeVO.getPageSize()), queryWrapper);
        return pageList;
    }
