...
public class BlogSortServiceImpl extends SuperServiceImpl<BlogSortMapper, BlogSort> implements BlogSortService {
    ...
    public IPage<BlogSort> getPageList(BlogSortVO blogSortVO) {
        ...
        return blogSortService.page(new Page<>(blogSortVO.getCurrentPage(),blogSortVO.getPageSize()));
    }
    ...
    public List<BlogSort> getList() {
        ...
        queryWrapper.orderByDesc(SQLConf.SORT);
        return blogSortService.list(queryWrapper);
    }
...
//        page.setCurrent(0);
//        page.setSize(1);
//        IPage<BlogSort> pageList = blogSortService.page(new Page<>(0,1), queryWrapper);
...
//        BlogSort maxSort = list.get(0);
    ...
    public BlogSort getTopOne() {
        ...
        return blogSortService.getOne(blogSortQueryWrapper);
    }
}
