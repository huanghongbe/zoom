...
import com.huanghongbe.zoom.commons.entity.Storage;
...
public class AdminServiceImpl extends SuperServiceImpl<AdminMapper, Admin> implements AdminService {
    ...
    public String getOnlineAdminList(AdminVO adminVO) {
        ...
        //截取出当前分页下的内容，后面考虑用Redis List做分页
...
//        page.setSize(adminVO.getPageSize());
        ...
        IPage<Admin> pageList = adminService.page(
                new Page<>(adminVO.getCurrentPage(),adminVO.getPageSize()), queryWrapper);
